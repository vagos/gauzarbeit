...
void PlayerAttackable::doAttack(const std::shared_ptr<Thing> &owner, const std::shared_ptr<Thing> &target)
{
...
void PlayerAttackable::onAttack(const std::shared_ptr<Thing> &owner, const std::shared_ptr<Thing> &attacker)
{
    std::stringstream res;
