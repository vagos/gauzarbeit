...
void PlayerNotifier::doNotify(const std::shared_ptr<Thing> &owner, Event::Type notification_type, const std::shared_ptr<Thing> &target)
{
...
void PlayerNotifier::onNotify(const std::shared_ptr<Thing> &owner, const std::shared_ptr<Thing> &actor, Event::Type notification_type, const std::shared_ptr<Thing>& target)
{
    switch (notification_type)
    {
       ...
       {
            std::stringstream chat; chat << "> " << actor->name << ": " << actor -> notifier() -> event.payload << '\n';
