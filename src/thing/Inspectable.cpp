...
const std::string Inspectable::onInspect(const std::shared_ptr<Thing> &owner, const std::shared_ptr<Thing> &inspector)
{
...
const std::string Inspectable::onHelp(std::shared_ptr<Thing> owner, std::shared_ptr<Thing> inspector)
{
    return "";
}
