...
RUN apt-get update
RUN apt-get install -y build-essential clang-format clang-tidy pkg-config python3 python3-pip libboost-all-dev liblua5.3-dev ninja-build doctest-dev git curl
