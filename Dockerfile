...
RUN apt-get update
RUN apt-get install -y build-essential clang-format clang-tidy pkg-config python3 python3-pip libboost-dev libboost-system-dev liblua5.3-dev doctest-dev git curl cmake ninja-build netcat-openbsd gdb
